...
import { Activity, Search, BarChart2, Layers } from 'lucide-react';
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto py-4">
        {Object.values(ALGORITHMS).map((algo: any) => {
             let Icon = BarChart2;
             if (algo.category === 'Searching') Icon = Search;
             if (algo.category === 'Data Structure') Icon = Layers;
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="text-xs text-gray-500 text-center">
            {isOpen ? "v1.1.0 • Powered by Gemini" : "v1.1"}
        </div>
      </div>
    </div>
  );
